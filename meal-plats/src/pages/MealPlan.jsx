...
const MealPlan = () => {
    ...
    useEffect(() => {
        const storageCal = 2000 //localStorage.getItem('CALORIES')
        if (storageCal) {
    ...
    const constructRecipeQuery = (type, totalcal) => {
        ...
        const baseQuery = "https://api.spoonacular.com/recipes/complexSearch?apiKey=debbfcabab43435f91fca421791c032d"; // a changer
            ...
            {progressBarIsOpen &&
                <Container fluid className=" w-100 transparent">
                    ...
                    <Row className="justify-content-around">
                        <Col md="2"><ProgressBarNutriment title="Protéines" number={totalProtein} totalNumber={neededNutriments.maxProtein} color='ff9900' /></Col>
                        <Col md="2"><ProgressBarNutriment title="Glucides" number={totalCarb} totalNumber={neededNutriments.maxCarb} color='82b700' /></Col>
                        <Col md="2"><ProgressBarNutriment title="Lipides" number={totalFat} totalNumber={neededNutriments.maxFat} color='00ebdd' /></Col>
                    </Row>
                    <br />
                </Container>
            }
